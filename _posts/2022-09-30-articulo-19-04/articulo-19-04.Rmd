...
![Distribución](i8.png)
La variable XX toma el valor de 11 cuando el éxito ocurre en el primer intento. Cuando el primer éxito ocurre en el evento dos, XX es igual a 22, es decir que la variable con distribución geométrica corresponde al número del evento donde ocurre el primer éxito.
